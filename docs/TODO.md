...
The claimable architectural lanes are WP-04, WP-05, and WP-07. WP-01, WP-02, WP-03, and WP-06 are settled foundations on `main`; WP-08 remains blocked on WP-05 and WP-07. Downstream packets should consume the landed interfaces rather than reimplementing upstream behavior.
