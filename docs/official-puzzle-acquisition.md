...
This capability is WP-07 in the repository work graph and landed through PR #16. Downstream puzzle-artifact materialization should consume these cached facts rather than re-reading mutable local source roots.
